...
public class MysqlGenerator {
     ...
     * 包所在路径
     */
    private static final String  packagePath="com.example.pm";
    /**
     * 实体所在的module
     */
     ...
     * 数据库表名，支持多个，用,隔开
     */
    private static final String bean="employment";
    /**
     * 数据库
     */
    private static final String database="pm";
    /**
     * 用户名
     */
     ...
     * 密码
     */
    private static final String password="ykh19980868";
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/pm?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC");
